...
const user_skill_repository_1 = require("./infra/db/repository/user-skill.repository");
const user_skill_entity_1 = require("./infra/db/entity/user-skill.entity");
...
const repositories = [
    ...
    { provide: 'UserSkillRepository', useClass: user_skill_repository_1.UserSkillRepository },
];
...
exports.UserModule = UserModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [cqrs_1.CqrsModule, auth_module_1.AuthModule, typeorm_1.TypeOrmModule.forFeature([user_entity_1.UserEntity, follow_entity_1.FollowEntity, user_skill_entity_1.UserSkillEntity])],
    })
], UserModule);
