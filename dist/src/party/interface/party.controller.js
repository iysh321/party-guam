...
const update_party_comand_1 = require("../application/command/update-party.comand");
const delete_party_comand_1 = require("../application/command/delete-party.comand");
...
let PartyController = class PartyController {
    ...
    async updateParty(payload, param, dto) {
        const { title, content } = dto;
        const command = new update_party_comand_1.UpdatePartyCommand(payload.id, param.partyId, title, content);
        return this.commandBus.execute(command);
    }
    async deleteParty(payload, param) {
        const command = new delete_party_comand_1.DeletePartyCommand(payload.id, param.partyId);
        this.commandBus.execute(command);
    }
    async getlikes(payload, query) {
        const { page, limit, sort, order } = query;
        const party = new get_party_like_query_1.GetPartyLikeQuery(payload.id, page, limit, sort, order);
        this.queryBus.execute(party);
    }
    async createPartyToLike(payload, param) {
        const command = new create_party_like_comand_1.CreatePartyLikeCommand(payload.id, param.partyId);
        this.commandBus.execute(command);
    }
    async deletePartyToLike(payload, param) {
        const command = new delete_party_like_comand_1.DeletePartyLikeCommand(payload.id, param.partyId);
        this.commandBus.execute(command);
    }
    ...
    async deletePartyComment(payload, commentId, dto) {
        dto;
    }
    async getPartyRequestList(payload, partyId, dto) {
        dto;
    }
    async sendPartyRequest(payload, commentId) {
        commentId;
    }
    async deletePartyRequest(payload, commentId) {
        commentId;
    }
    async getPartyInviteList(payload, partyId, dto) {
        dto;
    }
    async sendPartyInvite(payload, commentId, nickname, dto) {
        dto;
    }
    async deletePartyInvite(payload, commentId, nickname, dto) {
        dto;
    }
    async transferPartyLeadership(payload, commentId, dto) {
        dto;
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, party_param_request_dto_1.PartyRequestDto,
        update_party_request_dto_1.UpdatePartyRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, party_query_request_dto_1.PartyQueryRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, update_party_request_dto_1.UpdatePartyRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, auth_decorator_1.CurrentAccount)()),
    __param(1, (0, common_1.Param)('commentId')),
    __param(2, (0, common_1.Param)('nickname')),
    __param(3, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, String, party_param_request_dto_1.PartyRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, create_party_request_dto_1.CreatePartyRequestDto]),
    __metadata("design:returntype", Promise)
