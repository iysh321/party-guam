...
const commandHandlers = [create_user_handler_1.CreateUserHandler, kakao_login_handler_1.KakaoLoginHandler];
const queryHandlers = [get_user_by_nickname_handler_1.UserByNicknameHandler, get_user_handler_1.GetUserHandler, get_users_handler_1.GetUsersHandler];
const eventHandlers = [];
const factories = [user_factory_1.UserFactory];
const repositories = [{ provide: 'UserRepository', useClass: user_repository_1.UserRepository }];
...
exports.UserModule = UserModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [cqrs_1.CqrsModule, auth_module_1.AuthModule, typeorm_1.TypeOrmModule.forFeature([user_entity_1.UserEntity])],
    })
], UserModule);
